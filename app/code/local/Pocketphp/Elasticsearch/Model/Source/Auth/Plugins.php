 ...
 */
class Pocketphp_Elasticsearch_Model_Source_Auth_Plugins extends Mage_Core_Model_Abstract
{
    /**
     * Options getter
     *
    ...
    {
        return array(
            array('value' => 'none', 'label'=>Mage::helper('elasticsearch')->__('None')),
            array('value' => 'jetty', 'label'=>Mage::helper('elasticsearch')->__('Jetty')),
        );
    }
}
