 ...
 */
class Pocketphp_Elasticsearch_Block_Catalog_Layer_Filter_Category extends Mage_Catalog_Block_Layer_Filter_Abstract
{
    public function __construct()
    {
        parent::__construct();
        $this->_filterModelName = 'elasticsearch/catalog_layer_filter_category';
    }

    /**
     * Add params to faceted search
     *
     * @return Pocketphp_Elasticsearch_Block_Layer_Filter_Category
     */
